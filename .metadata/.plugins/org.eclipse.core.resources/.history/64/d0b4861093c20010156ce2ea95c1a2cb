...
/**
 * Clase que ofrece metodos estáticos para ayudar al testeo de GUI utilizando la
 * clase Robot
 */
...

{
    ...
    /**
     * @param delay atributo estatico que indica la cantidad de milisegundos de
     *              espera que usara el Robot.
     */
    ...
    /**
     * @return devuelve el atributo estatico delay que indica la cantidad de
     *         milisegundos de espera que usara el Robot
     */
    ...
    /**
     * Metodo que devuelve una referencia a un componente perteneciente a un
     * contenedor discriminado por su nombre
     ...
     * @return devuelve el componente con el nombre indicado. Si no hay ningun
     *         componente con el nombre buscado, se devolvera null
     */
     ...
     * Solo se aplica a textos que contengan letras de la 'a' a la 'z', tanto
     * mayusculas como minusculas.
     * 
     * @param texto Texto que se desea tipear. Debera contener solamente letras de
     *              la 'a' a la 'z', tanto mayusculas como minusculas.
     * @param robot Referencia al Robot que se utilizará
     */
    ...
    /**
     * Borra el texto de un JTextField simulando el pulsado de la tecla 'Delete'
     * utilizando la clase Robot
     * 
    ...
    public static void borraJTextField(JTextField jtextfield, Robot robot) {
        ...
        if (jtextfield != null && !jtextfield.getText().isEmpty()){
            robot.delay(getDelay());
            punto = TestUtils.getCentro(jtextfield);
            robot.mouseMove(punto.x, punto.y);
            robot.mousePress(InputEvent.BUTTON1_DOWN_MASK);
            robot.delay(getDelay());
            robot.mouseRelease(InputEvent.BUTTON1_MASK);
    ...
    public static void clickeaYEscribeTexto(Component component, String texto, Robot robot) {
        clickComponent(component, robot);
        tipeaTexto(texto, robot);
    }

    /**
     * Metodo que hace click en un elemento especifico de un JList utilizando la
     * clase Robot
     * 
